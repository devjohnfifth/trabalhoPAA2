...
public class Artista extends JFrame {
    ...
    public Artista(String title, List<Poligno> polygons) {
    ...
    private void updateXMargin(Poligno polygon) {
        double[] xRelPos = polygon.getposicaoRelativa();
    ...
    // Poligno polygon = polygonList.get(i);

    // int[] xPos = new int[5];
    // double[] xRelative = polygon.getposicaoRelativa();
    // for (int j = 0; j < 4; j++)
